...
public class Dabang2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("시작");
				...
				String str="p.text_a03"; // 내가 보고싶은 html 코드의 경로를 지정
				...
				DabangDAO dao = new DabangDAO();
				while(itr.hasNext())  { // .hasNext() = 다음 데이터가 있니?? 있으면 true
